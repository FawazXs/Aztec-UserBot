...
async def reedme(e):
    await e.edit(
        ...
        "\n[🚀 Aztec-Userbot Repo](https://github.com/FawazXs/Aztec-UserBot/blob/Aztec-UserBot/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "╭‒─‒──────────‒─‒╮\n"
        "│                   ʀᴇᴘᴏ\n"
        "│       [🚀Aztec-Userbot🚀](https://github.com/FawazXs/Aztec-UserBot)\n"
        "├‒─‒──────────‒─‒╯\n"
        "│🔰 **ᴏᴡɴᴇʀ :** [Aztec](t.me/xuxent)\n"
        "╰‒─‒──────────‒─‒╯\n"
